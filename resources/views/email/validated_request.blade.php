                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                                    Bonjour {{ $name }},
                                                                    <br>
                                                                    {{ auth()->user()->firstname. ' '. auth()->user()->lastname }} a validé votre  requête de dépense.
                                                                    <br>
                                                                    Cliquez sur le lien ci-dessous pour valider.
                                                                    <br>
                                                                    <a href="{{ env('APP_URL')}}/facturation_gestion_financiere/expenses_requests" class=" btn btn-success">Valider sa requête</a>
